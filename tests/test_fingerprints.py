...
def test_ec50_vs_m_returns_expected_columns():
    ...
    assert {"m", "ec50", "is_monotone", "has_sufficient_range", "is_reliable", "warning", "n_points", "dynamic_range", "monotonicity_score", "evidence_strength"}.issubset(set(out.columns))
...
def test_find_mechanical_optima_returns_expected_columns():
    ...
    assert {"c", "m_opt", "optimum_index", "is_edge", "is_interior", "prominence", "neighbor_margin", "response_span", "is_reliable", "warning", "evidence_strength", "n_mechanics_points"}.issubset(set(out.columns))
